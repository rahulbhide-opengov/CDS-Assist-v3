...
const TabPanel: React.FC<TabPanelProps> = ({ children, value, index }) => (
  <Box
    role="tabpanel"
    hidden={value !== index}
    id={`getting-started-tabpanel-${index}`}
    aria-labelledby={`getting-started-tab-${index}`}
  >
...
function a11yProps(index: number) {
  return {
    id: `getting-started-tab-${index}`,
    'aria-controls': `getting-started-tabpanel-${index}`,
  };
}
        ...
        >
          <Container maxWidth="lg">
            ...
            <Typography variant="h5" color="text.secondary" paragraph sx={{ maxWidth: 800 }}>
              Everything you need to build your first component and use Seamstress effectively
            </Typography>
            <Stack direction="row" spacing={2} sx={{ mt: 4 }}>
              <Chip label="Claude Code" color="primary" />
              <Chip label="Component Patterns" color="secondary" />
            ...
            <Paper elevation={0} sx={{ p: 4, mb: 6, border: `1px solid ${theme.palette.divider}` }}>
              ...
              <Stepper activeStep={activeStep} orientation="vertical">
                ...
                <Step>
                  ...
                  <StepContent>
                    <Typography variant="body2" paragraph>
                      Claude generates production-ready code. Verify these elements:
                    </Typography>
                    <List dense>
                      {[
...
└─────────────────────────────────────────────────────────────┘`}
            ...
            >
              ...
              <List dense disablePadding>
                {[
                  ...
                  { primary: 'Iterating on designs with stakeholder feedback', secondary: 'Make changes based on feedback, rebuild, and share updated previews' },
                ].map((item) => (
                ...
                <TableBody>
                  ...
                  <TableRow>
                    <TableCell>
                      <Stack direction="row" spacing={1} alignItems="center">
                        <CancelIcon color="error" fontSize="small" />
                        <Typography variant="body2">Push to production</Typography>
                      </Stack>
                    </TableCell>
                    <TableCell>
                      <Typography variant="body2">
                        Prototypes stay in seamstress-design for iteration. Production code is written separately by engineering teams.
                      </Typography>
                    </TableCell>
                  </TableRow>
                </TableBody>
            ...
            <Typography variant="body1" color="text.secondary" paragraph>
              Prototypes serve as living references for design exploration and stakeholder alignment&mdash;they&apos;re not directly deployed to production.
            </Typography>
            ...
            >
              <Stepper orientation="vertical" sx={{ mt: 1 }}>
                ...
                <Step active>
                  <StepLabel>
                    <Typography variant="subtitle1" fontWeight={600}>Code is NOT directly handed off to production</Typography>
                  </StepLabel>
                  <StepContent>
                    <Typography variant="body2" color="text.secondary">
                      Prototype code uses mock data and simplified patterns. Production code requires real APIs, authentication, error handling, and more. They&apos;re separate codebases.
                    </Typography>
                  </StepContent>
                </Step>
              </Stepper>
            ...
            <Alert severity="info">
              ...
              <Typography variant="body2">
                <strong>&quot;Can we share the prototypes with devs?&quot;</strong> Yes! Share the preview URL or point them to the PR. Developers can review the component structure and patterns, but they&apos;ll rebuild with real data sources and production requirements.
              </Typography>
            </Alert>
          </TabPanel>
        </Container>
