...
const DashboardPage: React.FC = () => {
  ...
  // Sample data for pie charts - using theme tokens for colors
  const userMessageBreakdown: UsageData[] = [
    { name: 'API', value: 45, color: theme.palette.primary.main },
    { name: 'Web', value: 30, color: theme.palette.info.main },
    { name: 'Mobile', value: 15, color: theme.palette.info.light },
    { name: 'CLI', value: 10, color: theme.palette.secondary.main },
  ];

  const agentUsageData: UsageData[] = [
    { name: 'Research', value: 35, color: theme.palette.primary.main },
    { name: 'Writing', value: 25, color: theme.palette.info.main },
    { name: 'Analysis', value: 20, color: theme.palette.info.light },
    { name: 'Support', value: 15, color: theme.palette.warning.main },
    { name: 'Other', value: 5, color: theme.palette.secondary.main },
  ];

  // Knowledge base data
  const knowledgeTypeBreakdown: UsageData[] = [
    { name: 'Markdown', value: 142, color: theme.palette.primary.main },
    { name: 'PDF', value: 89, color: theme.palette.info.main },
    { name: 'CSV/Excel', value: 56, color: theme.palette.info.light },
    { name: 'Word', value: 34, color: theme.palette.success.main },
    { name: 'Text', value: 28, color: theme.palette.warning.main },
  ];

  const skillUsageData: UsageData[] = [
    { name: 'Data Processing', value: 40, color: theme.palette.primary.main },
    { name: 'Content Generation', value: 25, color: theme.palette.info.main },
    { name: 'Code Review', value: 20, color: theme.palette.info.light },
    { name: 'Translation', value: 10, color: theme.palette.warning.main },
    { name: 'Other', value: 5, color: theme.palette.secondary.main },
  ];

  const toolUsageData: UsageData[] = [
    { name: 'Search', value: 30, color: theme.palette.primary.main },
    { name: 'Database', value: 25, color: theme.palette.info.main },
    { name: 'API', value: 20, color: theme.palette.info.light },
    { name: 'File System', value: 15, color: theme.palette.warning.main },
    { name: 'Other', value: 10, color: theme.palette.secondary.main },
  ];
  ...
  const renderPieChart = (data: UsageData[], ariaLabel: string) => (
    <Box sx={{ width: 200, height: 200, mx: 'auto' }} role="img" aria-label={ariaLabel}>
  ...
  const renderTable = (data: TableData, ariaLabel: string) => (
    <TableContainer
      sx={{
        maxHeight: 400,
        overflow: 'auto',
        ...
        <Box component="section" role="region" aria-labelledby="knowledge-base-heading">
          ...
          <CardContent>
            <Stack
              ...
              spacing={2}
            >
              <Typography variant={isMobile ? 'body1' : 'h6'} fontWeight="bold" id="knowledge-base-heading" component="h2">
                Knowledge Base
              </Typography>
              ...
              <Stack sx={{ width: { xs: '100%', md: '420px' }, flexShrink: 0 }} alignItems="center">
                ...
                <Box sx={{ mt: 2, px: 2 }}>
                  ...
                  <LinearProgress
                    variant="determinate"
                    value={16.8}
                    aria-label="Storage usage: 8.4 GB of 50 GB used"
                    sx={{
                      height: 6,
                      borderRadius: 1,
        ...
        <Box component="section" role="region" aria-labelledby="user-messages-heading">
          ...
          <CardContent>
            <Stack
              ...
              spacing={1}
            >
              <Typography variant={isMobile ? 'body1' : 'h6'} fontWeight="bold" id="user-messages-heading" component="h2">
                User/Messages Breakdown
              </Typography>
            </Stack>
            <Stack direction={{ xs: 'column', md: 'row' }} spacing={3}>
              <Stack sx={{ width: { xs: '100%', md: '420px' }, flexShrink: 0 }} alignItems="center">
                {renderPieChart(userMessageBreakdown, 'User message sources: API 45%, Web 30%, Mobile 15%, CLI 10%')}
                {renderLegend(userMessageBreakdown)}
              </Stack>
              <Box sx={{ flex: 1, minWidth: 0, overflow: 'hidden' }}>
                {renderTable(userTableData, 'User activity statistics')}
              </Box>
            </Stack>
          </CardContent>
          </Card>
        ...
        <Box component="section" role="region" aria-labelledby="agent-usage-heading">
          ...
          <CardContent>
            <Stack
              ...
              spacing={1}
            >
              <Typography variant={isMobile ? 'body1' : 'h6'} fontWeight="bold" id="agent-usage-heading" component="h2">
                Agent Usage
              </Typography>
            ...
            <Stack direction={{ xs: 'column', md: 'row' }} spacing={3}>
              ...
              <Box sx={{ flex: 1, minWidth: 0, overflow: 'hidden' }}>
                {renderTable(agentTableData, 'Agent performance statistics')}
              </Box>
            </Stack>
          </CardContent>
          </Card>
        ...
        <Box component="section" role="region" aria-labelledby="skill-usage-heading">
          ...
          <CardContent>
            <Stack
              ...
              spacing={1}
            >
              <Typography variant={isMobile ? 'body1' : 'h6'} fontWeight="bold" id="skill-usage-heading" component="h2">
                Skill Usage
              </Typography>
              <Stack direction="row" spacing={1} alignItems="center" flexWrap="wrap">
                <Button
        ...
        <Box component="section" role="region" aria-labelledby="tool-usage-heading">
          ...
          <CardContent>
            <Stack
              ...
              spacing={1}
            >
              <Typography variant={isMobile ? 'body1' : 'h6'} fontWeight="bold" id="tool-usage-heading" component="h2">
                Tool Usage
              </Typography>
              <Stack direction="row" spacing={1} alignItems="center" flexWrap="wrap">
                <Button
            ...
            <Stack direction={{ xs: 'column', md: 'row' }} spacing={3}>
              ...
              <Box sx={{ flex: 1, minWidth: 0, overflow: 'hidden' }}>
                {renderTable(toolTableData, 'Tool call statistics')}
              </Box>
            </Stack>
          </CardContent>
          </Card>
