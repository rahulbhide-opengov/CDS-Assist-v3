...
export default function MobileAccessibilityContent() {
  const theme = useTheme();
      ...
      <Container maxWidth="lg">
        ...
        <TabPanel value={tabValue} index={0}>
            ...
            <Table>
              <TableHead>
                <TableRow sx={{ bgcolor: theme.palette.background.secondary }}>
                  <TableCell sx={{ fontWeight: 600 }}>Button Size</TableCell>
                  <TableCell sx={{ fontWeight: 600 }}>Height</TableCell>
                  <TableCell sx={{ fontWeight: 600 }}>Usage</TableCell>
                  <TableCell sx={{ fontWeight: 600 }}>WCAG Touch Target</TableCell>
                </TableRow>
              </TableHead>
              <TableBody>
                <TableRow>
                  ...
                  <TableCell>Primary CTAs, hero sections</TableCell>
                  <TableCell sx={{ color: 'success.main' }}>Meets 44px with padding</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell><strong>Medium</strong> (default)</TableCell>
                  <TableCell>32px</TableCell>
                  <TableCell>Standard actions, forms</TableCell>
                  <TableCell sx={{ color: 'warning.main' }}>Add 6px vertical padding for 44px</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell><strong>Small</strong></TableCell>
                  <TableCell>26px</TableCell>
                  <TableCell>Inline actions, dense UIs</TableCell>
                  <TableCell sx={{ color: 'warning.main' }}>Add 9px vertical padding for 44px</TableCell>
                </TableRow>
              </TableBody>
            </Table>
          </TableContainer>
          ...
          <Alert severity="warning" sx={{ mb: 4 }}>
            <strong>Important:</strong> While our button heights are smaller than the WCAG 44px recommendation,
            the clickable area can be extended using padding. Ensure touch targets meet accessibility requirements
            on mobile by using <code>sx={'{{'} py: 1.5 {'}}'}</code> or larger buttons for touch interfaces.
          </Alert>

          {/* WCAG Touch Target Sizes Table */}
          <Typography variant="h5" gutterBottom sx={{ fontWeight: 600, mb: 3 }}>
            ...
            <Table>
              <TableHead>
                <TableRow sx={{ bgcolor: theme.palette.background.secondary }}>
                  ...
                  <TableCell sx={{ fontWeight: 600 }}>WCAG Minimum</TableCell>
              ...
              <TableBody>
                <TableRow>
                  <TableCell>All Interactive Elements</TableCell>
                  <TableCell>44 × 44px</TableCell>
                  <TableCell>48 × 48px</TableCell>
                  <TableCell>WCAG 2.5.5 Target Size (Enhanced)</TableCell>
                </TableRow>
                <TableRow>
